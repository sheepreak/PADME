...
public class HospitalSetup {
    ...
    private void createData() {
        ...
        Staff doc1 = new Staff("mgrey", "mgrey", "Grey", "Meredith", "0606060608", "15 rue Chapatte 75001 Paris", Status.MEDICAL);
        doc1.setNode(nodePole2);
        staffRepository.save(doc1);

        Staff doc2 = new Staff("cyang", "cyang", "Yang", "Cristina", "0606060609", "25 allée de la brûme 75012 Paris", Status.MEDICAL);
        doc2.setNode(nodeService11);
        staffRepository.save(doc2);

        Staff doc3 = new Staff("dshep", "dshep", "Shepherd", "Derek", "0606060610", "15 rue Chapatte 75001 Paris", Status.MEDICAL);
        doc3.setNode(nodeService12);
        staffRepository.save(doc3);

        Staff doc4 = new Staff("akepn", "akepn", "Kepner", "April", "0606060611", "32 rue de la mairie 77450 Esbly", Status.MEDICAL);
        doc4.setNode(nodeService13);
        staffRepository.save(doc4);

        Staff doc5 = new Staff("arobb", "arobb", "Robbins", "Arizona", "0606060612", "47 rue Pasteur 77700 Coupvray", Status.MEDICAL);
        doc5.setNode(nodeService14);
        staffRepository.save(doc5);

        Staff doc6 = new Staff("mbail", "mbail", "Bailey", "Miranda", "0606060613", "25 avenue de la République 77340 Pontault-Combault", Status.MEDICAL);
        doc6.setNode(nodePole1);
        staffRepository.save(doc6);

        Staff doc7 = new Staff("ohunt", "ohunt", "Hunt", "Owen", "0606060615", "64 allée des mille et une nuits 77184 Emerainville", Status.MEDICAL);
        doc7.setNode(nodePole3);
        staffRepository.save(doc7);

        Staff doc8 = new Staff("ghous", "ghous", "House", "Gregory", "0606060616", "18 allée Montesquieu 93190 Livry-Gargan", Status.MEDICAL);
